...
<head>
    ...
    <style>
        ...
        .page-header { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; border-radius: 12px; }
    </style>
</head>
<body>
    <!-- 导航栏 -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="page-header p-4 mb-4">
                    <h4 class="mb-0"><i class="bi bi-pencil-square"></i> 编辑员工信息</h4>
                    <small class="opacity-75">修改员工 ID: ${employee.id} 的信息（第1题：根据id修改员工信息）</small>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">
                                    <i class="bi bi-hash text-primary"></i> 员工ID
                                </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="empName" required
                                       value="${employee.empName}" maxlength="20">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">
                                ...
                                <input type="number" class="form-control" name="empAge"
                                       value="${employee.empAge}" min="1" max="150">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">
                                ...
                                <select class="form-select" name="empGender">
                                    ...
                                    <option value="M" ${employee.empGender == 'M' ? 'selected' : ''}>男</option>
                                    <option value="F" ${employee.empGender == 'F' ? 'selected' : ''}>女</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">
                                ...
                                <input type="email" class="form-control" name="empEmail"
                                       value="${employee.empEmail}" maxlength="50">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">
                                ...
                                <select class="form-select" name="empDept">
                                    ...
                                    <option value="技术部" ${employee.empDept == '技术部' ? 'selected' : ''}>技术部</option>
                                    <option value="市场部" ${employee.empDept == '市场部' ? 'selected' : ''}>市场部</option>
                                    <option value="人事部" ${employee.empDept == '人事部' ? 'selected' : ''}>人事部</option>
                                    <option value="财务部" ${employee.empDept == '财务部' ? 'selected' : ''}>财务部</option>
                                    <option value="测试部" ${employee.empDept == '测试部' ? 'selected' : ''}>测试部</option>
                                </select>
                            </div>
                        </div>
